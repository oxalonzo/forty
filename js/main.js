$(document).ready(function () {
    ...
    var fotoSeis = $('.foto-seis');

    $(fotoSeis).mouseenter(function () {
    ...
    $(subir).mouseenter(function() {
        $(this).css('border',' solid 2px #9bf1ff')
        $(this).css('background','rgba(0,0,0,0.3)');
    });

    $(subir).mouseleave(function() {
